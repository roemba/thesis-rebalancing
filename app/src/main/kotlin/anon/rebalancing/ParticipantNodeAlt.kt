...
open class ParticipantNodeAlt(id: Int, g: ChannelNetwork, counter: Counter, random: SeededRandom, globalLogger: Logger, rebalancingTriggerPoint: Float, val randomDeny: Boolean = false) : Node(id, g, counter, random, globalLogger, rebalancingTriggerPoint) {
    var started = false
