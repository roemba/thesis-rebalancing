...
class Channel(val node1: Node, val node2: Node, var balance1: Int, var balance2: Int) {
    ...
    fun requestTx(tx: Transaction): Boolean {
    ...
    fun executeTx(tx: Transaction): Boolean {
        if (tx !in pendingTransactions) {
            return false
        }
    ...
    override fun equals(other: Any?): Boolean {
        return (other is Channel) && (this.toString() == other.toString())
    }
